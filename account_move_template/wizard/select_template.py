...
class WizardSelectMoveTemplate(models.TransientModel):
    ...
    def load_template(self):
       ...
       # obsolete . la notion de periode n'est plus disponible dans v9
       #
    ...
    @api.model
    #def _make_transitory_move_line(self, line, computed_lines, move_id, period_id, trans_account_id, partner_id):
