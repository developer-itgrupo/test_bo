...
class MassReconcileAdvancedRef(models.TransientModel):
    ...
    def _skip_line(self, move_line):
        ...
        """
        return not (move_line.get('type_document_it') and move_line.get('nro_comprobante') and move_line.get('partner_id'))
    ...
    def _matchers(self, move_line):
        ...
        """
        return (('partner_id', move_line['partner_id']),
                ('nro_comprobante', move_line['nro_comprobante']),
                ('type_document_it', move_line['type_document_it']))
    ...
    def _opposite_matchers(self, move_line):
        ...
        """
        yield ('partner_id', move_line['partner_id'])
        yield ('nro_comprobante', move_line['nro_comprobante'])
        yield ('type_document_it', move_line['type_document_it'])
