...
class account_statement_move_import_wizard(models.TransientModel):
    ...
    def confirm(self):
        ...
        for line in self.move_line_ids:
            ...
            payment = line.move_id.means_payment_it
            ...
            line_vals = {
                ...
                'medio_pago':payment.id,
            }

            # create statement line
            if line.payment_id.id:
                line.payment_id.payment_reference = line.move_id.name
...
class account_bank_statement(models.Model):
    ...
    @api.one
    def cancel_reconciliation_all(self):
        for i in self.line_ids:
            i.button_cancel_reconciliation()