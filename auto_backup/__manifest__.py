...
If you want to write to an external server with SFTP(pip install pysftp) you will need to provide the IP, username and password for the remote backups.
