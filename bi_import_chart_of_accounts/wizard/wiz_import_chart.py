...
# ------------------------------------------------------------						
	...
	def create_chart_accounts(self,values):
		...
		if values.get("clasification_sheet") == "":
			raise Warning(_('Debe seleccionar la clasificacion en la HT') )
			
		if values.get("level_sheet") == "":
			raise Warning(_('Debe seleccionar un nivel la HT') )	
...
# ------------tags
		...
		abc = {
				...
				'clasification_sheet' : values.get('clasification_sheet'),
				'level_sheet' : values.get('level_sheet')
